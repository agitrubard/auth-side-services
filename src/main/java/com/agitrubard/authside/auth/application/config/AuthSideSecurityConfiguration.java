    ...
    SecurityFilterChain filterChain(HttpSecurity httpSecurity,
        ...
        httpSecurity
                ...
                .authorizeHttpRequests(customizer -> customizer
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/permissions").hasAnyAuthority("role:add", "role:update")
                        .requestMatchers(HttpMethod.POST, "/api/v1/role").hasAnyAuthority("role:add", "role:update")
