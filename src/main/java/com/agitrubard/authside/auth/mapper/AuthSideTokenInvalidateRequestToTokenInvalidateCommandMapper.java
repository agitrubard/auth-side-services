 ...
 * {@link AuthSideTokensInvalidateRequest} to their corresponding command representations, {@link AuthSideTokenInvalidateCommand}.
 ...
 */
@Mapper
public interface AuthSideTokenInvalidateRequestToTokenInvalidateCommandMapper extends AuthSideBaseMapper<AuthSideTokensInvalidateRequest, AuthSideTokenInvalidateCommand> {

    /**
     * Initializes and returns an instance of the {@code AuthSideTokenInvalidateRequestToTokenInvalidateCommandMapper}.
     *
     * @return An instance of the mapper for converting between {@link AuthSideTokensInvalidateRequest} and {@link AuthSideTokenInvalidateCommand}.
     */
